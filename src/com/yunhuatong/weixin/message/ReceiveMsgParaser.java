...
import com.yunhuatong.tool.StrTool;
...
public class ReceiveMsgParaser {
	
	private ReceiveMsgParaser() {}
	...
	private static InMsg parseInVoiceMsgAndInSpeechRecognitionResults(Element root, String toUserName, String fromUserName, Integer createTime, String msgType) {
		...
		if (StrTool.isBlank(recognition)) {
	...
	private static InMsg parseInEvent(Element root, String toUserName, String fromUserName, Integer createTime, String msgType) {
		...
		if (("subscribe".equals(event) || "unsubscribe".equals(event)) && StrTool.isBlank(eventKey)) {
		...
		if ("subscribe".equals(event) && StrTool.notBlank(eventKey) && eventKey.startsWith("qrscene_")) {
